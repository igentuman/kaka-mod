package com.igentuman.kaka.entity.model;
...
public class KakaDemonModel<T extends KakaDemon> extends HierarchicalModel<T> {
    ...
    public KakaDemonModel(ModelPart p_170697_) {
        this.root = p_170697_;
